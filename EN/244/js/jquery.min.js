		...
		ajax: function (a, b) {
			...
			if (
				...
				null == k.crossDomain &&
					...
					(k.crossDomain = !(
						!c ||
						(c[1] === zc[1] && c[2] === zc[2] && (c[3] || ('http:' === c[1] ? '80' : '443')) === (zc[3] || ('http:' === zc[1] ? '80' : '443')))
					))),
			...
			function x(a, b, c, d) {
				...
				2 !== t &&
					...
					j
						? (k.ifModified &&
								((w = v.getResponseHeader('Last-Modified')), w && (n.lastModified[e] = w), (w = v.getResponseHeader('etag')), w && (n.etag[e] = w)),
						  204 === a || 'HEAD' === k.type
								? (x = 'nocontent')
								: 304 === a
								? (x = 'notmodified')
